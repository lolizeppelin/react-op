...
const data = {
  menus: [
    { id: 'gogamechen1-page',
      ...
      children: [
        { id: 'gogamechen1-objfile-page', text: '更新文件管理', url: `${BASEPATH}/objfiles`, index: 5 },
        { id: 'gogamechen1-group-page', text: '游戏组管理', url: `${BASEPATH}/`, index: 6 },
        { id: 'gogamechen1-gmsvr-page', text: 'GM程序管理', url: `${BASEPATH}/gmsvrs`, index: 7 },
        ...
        { id: 'gogamechen1-warsvr-page', text: '战斗计算程序管理', url: `${BASEPATH}/warsvrs`, index: 10 },
        { id: 'gogamechen1-warsvrset-page', text: '战斗计算组管理', url: `${BASEPATH}/warsvrsets`, index: 11 },
        { id: 'gogamechen1-page', text: '包管理', url: `${BASEPATH}/packages`, index: 12 },
        { id: 'gogamechen1-noitfy', text: '通知接口调用', url: `${BASEPATH}/notifys`, index: 13 },
      ],
    },
    { id: 'gopcdn-page',
      text: 'CDN管理',
