...
export function signInStaticToken(payload) {
  return {
    type: ActionTypes.SIGN_BY_STATIC_TOKEN,
    payload,
  };
}


export function signInDynamicToken(payload) {
  return {
    type: ActionTypes.SIGN_BY_DYNAMIC_TOKEN,
    payload,
  };
}
