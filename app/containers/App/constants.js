...
export const SIGN_BY_STATIC_TOKEN = 'app/SIGN_BY_STATIC_TOKEN';
export const SIGN_BY_DYNAMIC_TOKEN = 'app/SIGN_BY_DYNAMIC_TOKEN';
export const LOGIN_OUT = 'app/LOGIN_OUT';
